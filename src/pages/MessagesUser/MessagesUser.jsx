                ...
                <form action="" onSubmit={handlerSubmit} className="w-full flex items-center p-6 gap-3 flex-col justify-around h-1/2 ">
                    ...
                    inputs.map((data, i )=>(
                        <div key={i} className="flex flex-col items w-full">
                            ...
                            {data.type!=='text'?<textarea ref={data.refference} placeholder={data.placeholder} className="border p-1 focus:outline-purple-400" rows='2' cols='30'/>:(
                            <div className="flex gap-2">
                                <input className="p-1 w-5/6 border focus:outline-purple-400" type={data.type} placeholder={data.placeholder} ref={data.refference} />
                                <button className="p-1 border rounded-xl flex items-center justify-center">
